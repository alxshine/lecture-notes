...
They contain syntactic sugar like shown in \Cref{fig:ebnfstar}, which is equivalent to $term\ (addop\ term)^*$.
...
\Cref{fig:calling} shows a nice visualization of a call graph.
...
\Cref{fig:stack} shows a graphical representation of \emph{The Stack}.
